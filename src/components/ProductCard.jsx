...
function ProductCard({ product, quantity, onAdd, onDecrease }) {
  return (
    <article className="flex h-full flex-col rounded-[24px] border border-[#E5E7EB] bg-white p-3 shadow-[0_8px_24px_rgba(17,17,17,0.05)] transition hover:-translate-y-1 hover:shadow-[0_14px_30px_rgba(17,17,17,0.08)]">
      ...
      <div className="flex flex-1 flex-col">
        <h2 className="mb-2 text-[1.35rem] font-semibold leading-7 text-[#111111]">
          {product.title}
        </h2>
